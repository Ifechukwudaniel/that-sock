          ...
          <div className="mint__card__background-4">
            <div className="Mint__Card">
              ...
              <div className="SocksCardImage">
                <img src={"/assets/sockScratch.png"} />
              </div>
              <div className="Footer__Text">
                <b>
                  Only <span>3728 Socks</span>available on a price curve <span>increasing 0.2% </span>with each new
                  mint. // Double the supply of the <a href="#">Original Ethereum Mainnet That Socks!</a>
                </b>
              </div>
              <div>
